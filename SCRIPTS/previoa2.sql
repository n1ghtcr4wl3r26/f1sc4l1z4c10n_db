/* Formatted on 1-ago.-2017 22:27:47 (QP5 v5.126) */
  ...
  SELECT   gestion,
           ...
           estado_control,
           SUBSTR (tbl.ilicitos, 1, INSTR (tbl.ilicitos, '&') - 1)
        omision_pago,
    ...
    FROM   (SELECT   f1.ctl_cod_gestion gestion,
                     ...
                     pkg_reporte.devuelve_ilicitos (f1.ctl_control_id)
        ilicitos,
                     TO_CHAR (
                     ...
                     TO_CHAR (sad_gen.sad_reg_date, 'dd/mm/yyyy')
                         fecha_registro,
                     sad_gen.sad_typ_dec || '-' || sad_gen.sad_typ_proc patron
        -- campo 1   (7)
                     ,
                     NVL (
                         DECODE (spyc.sad_clr,
        ...
        -- campo 2c
                     ...
                     || SUBSTR (sad_gen.sad_lop_cod, 1, 2)
                         pto_pais_embarque                         -- campo 27
                                          ,
                     NVL (itm.saditm_gross_mass, 0) total_peso_bruto
        -- campo 6b (84)
                                                                    ,
                     NVL (itm.saditm_net_mass, 0) total_peso_neto
        -- campo 6b (84)
                                                                 ,
